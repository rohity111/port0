                ...
                <div className='cardq'>
                    ...
                    <div className='card1' data-aos="fade-up">
                        <div class="card "  >
                            ...
                            <div class="card-body">
                                <p class="card-text">Dr RMLAU Ayodhya</p>
                                <b>2020-2024</b>
                                <p class="card-text">B.Tech from IET in the department of Computer Science Engineering.</p>
                    ...
                    <div className='card1' data-aos="fade-up">
                        <div class="card "  >
                            ...
                            <div class="card-body">
                                ...
                                <b>2018-2019</b>
                                <p class="card-text">I have completed 12th from SSC Inter College with 76%</p>
                            </div>
                        </div>
                    </div>
                    <div className='card1' data-aos="fade-up">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <p class="card-text">Sardar Singh Convent Inter College</p>
                                <b>2016-2017</b>
                                <p class="card-text">I have completed 10th from SSC Inter College with 79.0%</p>
                            </div>
                        </div>
                    </div>
