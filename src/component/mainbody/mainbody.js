    ...
    <>
      <div className='main-container1'>
        <div className='main-bo' id='home12'>
          <div className='main1' id='m1'>
            ...
            <h1 className='h-about' data-aos="zoom-in">I'm Rohit </h1>
            <p className='main1-p'>rohitkumaryadav451@gmail.com</p>
          ...
          <div className='main2' id='m2'>
           ...
           <a href='finalresume.pdf' download="rohit.pdf"><button className='button'>Download Resume</button></a>
            </div>
          ...
          <div className='main3' id='m3'>
            ...
            <h3 className='main1-h3' data-aos="zoom-in">CERTIFIED .net MVC DEVELOPER</h3>
          </div>
      ...
      <div className='main-container2' id='about12'>
        ...
        <div className='main-c2'>
          ...
          <p className='main-p1 '  data-aos="zoom-in"> Currently I am Prefinal Student in Dr RMLAU Institute of Engineering and Technology. Pursuing an undergraduate degree in CSE. I am interested in exploring the fields of Software Engineering</p>
